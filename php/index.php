	...
	<div class="top-header" >		
		...
		<div class="top-nav">		
			  <span class="menu"><img src="images/menu.png" alt=""> </span>
					...
					<ul>
						<li class="active"><a class="color1" href="index.php"  >Home</a></li>
						<li><a class="color2" href="games.php"  >Games</a></li>
						
						<li><a class="color4" href="register.html" >Register</a></li>
						<li><a class="color5" href="login.html"  >Log In</a></li>
						<li><a class="color6" href="contact2.php" >Contact</a></li>
						<li>
